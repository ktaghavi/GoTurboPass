...
def seed_database():
    ...
    with app.app_context():
        ...
        # SAFER for Alembic projects: clear rows but keep schema + alembic_version
        ...
        # 3) Modules + Quizzes (use the one-to-one relationship via Quiz.module)
        print("  Creating sample modules + quizzes…")
        ...
        db.session.flush()  # ensure module1.id

        # Create quiz via relationship (no module.quiz_id anymore)
        quiz1 = Quiz(module=module1, pass_percent=70)
        ...
        quiz2 = Quiz(module=module2, pass_percent=70)
        ...
        questions2 = [
            ...
            Question(
                ...
                options={"A": "The largest vehicle", "B": "The vehicle on the right", "C": "The first vehicle to arrive", "D": "The fastest vehicle"},
                answer_key="C",
            ),
            Question(
                quiz_id=quiz2.id,
                stem="What should you do when an emergency vehicle with lights and sirens approaches?",
                options={"A": "Speed up to get out of the way", "B": "Pull over to the right and stop", "C": "Continue driving normally", "D": "Turn left at the next intersection"},
                answer_key="B",
            ),
        ]
